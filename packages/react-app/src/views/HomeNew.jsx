...
function HomeNew({ mainnetProvider, localProvider, readContracts, address, userSigner, tx, blockExplorer, writeContracts, web3Modal, loadWeb3Modal, logoutOfWeb3Modal }) {
  ...
  const [sourceNftId, setSourceNftId] = useState();
  const [targetNftCollection, setTargetNftCollection] = useState();
  const [targetNftId, setTargetNftId] = useState();
  return (
    <div>
      <Select
        defaultValue=""
